  ...
  return (
    <div className="flex gap-6 px-8 py-6 border-b-2 border-gray-900">
      ...
      <div className="flex-1">
        <div
          className="min-h-14 outline-none text-lg text-white rounded-md empty:before:text-gray-500 empty:before:content-[attr(data-placeholder)]"
          contentEditable
          role="textbox"
          data-placeholder="O que está acontecendo ?"
        ></div>

        <div className="flex justify-between items-certer mt-2">
